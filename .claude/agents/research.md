---
name: research
description: "use this agent if user asks to research a subject"
model: sonnet
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/home/maxwalks/Documents/Projects/arr_gateway/.claude/agent-memory/research/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/home/maxwalks/Documents/Projects/arr_gateway/.claude/agent-memory/research/" glob="*.md"
```
