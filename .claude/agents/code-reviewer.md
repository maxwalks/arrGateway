---
name: code-reviewer
description: "use this agent when user asks for a code reviewer"
model: sonnet
memory: project
---
...
You have a persistent Persistent Agent Memory directory at `/home/maxwalks/Documents/Projects/arr_gateway/.claude/agent-memory/code-reviewer/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/home/maxwalks/Documents/Projects/arr_gateway/.claude/agent-memory/code-reviewer/" glob="*.md"
```
2. Session transcript logs (last resort — large files, slow):
```
Grep with pattern="<search term>" path="/home/maxwalks/.claude/projects/-home-maxwalks-Documents-Projects-arr-gateway/" glob="*.jsonl"
```
